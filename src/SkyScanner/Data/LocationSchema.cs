...
namespace SkyScanner.Data
{
    ...
    {
        /// <summary>
        /// For airports and cities the internationally recognized IATA schema can be used.
        /// For countries the ISO schema can be used. This combined IATA/ISO schema is the
        /// default schema for use with Skyscanner services.
        /// </summary>
        Iata,
        /// <summary>
